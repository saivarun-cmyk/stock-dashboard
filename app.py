...
st.markdown(
    "India + USA Stocks | SMA10 Scanner | Bullish / Neutral / Bearish"
)
...
with c2:
    st.info(
        f"🇺🇸 New York Time : "
        f"{usa_time.strftime('%d-%b-%Y %I:%M:%S %p')}"
    )
...
# ==========================================================
    ...
    if not neutral_df.empty:
        ...
        neutral_df = neutral_df.sort_values(
            by="Score",
            ascending=False
        )
...
# ==========================================================
    ...
    with tab2:
        ...
        st.subheader(
            f"🎯 Stocks Within {sma_threshold}% Of SMA10"
        )

        if sma_df.empty:

            st.warning(
                "No Stocks Found Near SMA10"
            )
...
# ==========================================================
    ...
    with s1:
        ...
        st.success(
            f"🔥 Bullish Stocks : {len(bullish_df)}"
        )

    with s2:

        st.info(
            f"➖ Neutral Stocks : {len(neutral_df)}"
        )

    with s3:

        st.error(
            f"⚠️ Bearish Stocks : {len(bearish_df)}"
        )
...
# ==========================================================
    ...
    st.info(
        "🔔 Telegram Alerts Module Coming Soon"
    )
